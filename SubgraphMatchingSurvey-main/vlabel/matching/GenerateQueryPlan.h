...
public:
    static void generateDSQLQueryPlan(const Graph *data_graph, const Graph *query_graph, ui *candidates_count,
                                             ui *&order, ui *&pivot);
    static VertexID selectDSQLStartVertex(const Graph *query_graph, ui *candidates_count);

    static void generateGQLQueryPlan(const Graph *data_graph, const Graph *query_graph, ui *candidates_count,
                                         ui *&order, ui *&pivot);
    // これはMatCo用のordering決定プラン
    static void generateDEGQueryPlan(const Graph *data_graph, const Graph *query_graph, ui *candidates_count, ui *&order, ui *&pivot);
